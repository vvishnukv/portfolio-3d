    ...
    <div style={{ width: '100vw', backgroundColor: theme.bg, color: theme.textMain, position: 'relative' }}>
      ...
      <nav style={{
        ...
        <div style={{ display: 'flex', gap: '2rem', alignItems: 'center', flexWrap: 'wrap' }}>
          <a href="#home" style={{ color: theme.textMain, textDecoration: 'none', fontWeight: 600, fontSize: '0.9rem' }}>Home</a>
          <a href="#about" style={{ color: theme.textMain, textDecoration: 'none', fontWeight: 600, fontSize: '0.9rem' }}>About</a>
          <a href="#experience" style={{ color: theme.textMain, textDecoration: 'none', fontWeight: 600, fontSize: '0.9rem' }}>Experience</a>
          <a href="#projects" style={{ color: theme.textMain, textDecoration: 'none', fontWeight: 600, fontSize: '0.9rem' }}>Projects</a>
          <a href="#skills" style={{ color: theme.textMain, textDecoration: 'none', fontWeight: 600, fontSize: '0.9rem' }}>Skills</a>
          <a href="#education" style={{ color: theme.textMain, textDecoration: 'none', fontWeight: 600, fontSize: '0.9rem' }}>Education</a>
          <a href="#contact" style={{ color: theme.textMain, textDecoration: 'none', fontWeight: 600, fontSize: '0.9rem' }}>Contact</a>
        </div>
      </nav>
      ...
      <div style={{ position: 'relative', zIndex: 1, paddingTop: '70px' }}>
        ...
        <section id="about" style={{ minHeight: '80vh', display: 'flex', flexDirection: 'column', justifyContent: 'center', padding: '10vh 10vw' }}>
          ...
          <div style={{ background: theme.cardBg, border: `1px solid ${theme.cardBorder}`, padding: '3rem', borderRadius: '1rem', backdropFilter: 'blur(12px)', maxWidth: '900px' }}>
        ...
        <section id="experience" style={{ minHeight: '100vh', display: 'flex', flexDirection: 'column', justifyContent: 'center', padding: '10vh 10vw' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '2.5rem', maxWidth: '1000px' }}>
            ...
            <div className="interactive-card" style={{ background: theme.cardBg, border: `1px solid ${theme.cardBorder}`, padding: '2.5rem', borderRadius: '1rem', backdropFilter: 'blur(12px)' }}>
              ...
              <h4 style={{ color: '#38bdf8', fontSize: '1.05rem', marginBottom: '1.5rem' }}>Hyderabad, India • Sep 2023 – Mar 2024[cite: 1]</h4>
              <ul style={{ color: theme.textMuted, lineHeight: 1.7, paddingLeft: '1.2rem', display: 'flex', flexDirection: 'column', gap: '0.8rem' }}>
        ...
        <section id="projects" style={{ minHeight: '100vh', display: 'flex', flexDirection: 'column', justifyContent: 'center', padding: '10vh 5vw' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(340px, 1fr))', gap: '2rem', padding: '0 5vw' }}>
            ...
            <div className="interactive-card" style={{ background: theme.cardBg, border: `1px solid ${theme.cardBorder}`, padding: '2.5rem', borderRadius: '1rem', backdropFilter: 'blur(12px)' }}>
              <h3 style={{ fontSize: '1.35rem', marginBottom: '0.8rem', color: theme.textMain }}>Containerized Research Data Pipeline[cite: 1]</h3>
              <p style={{ color: theme.textMuted, fontSize: '0.95rem', lineHeight: 1.6, marginBottom: '1.5rem' }}>
                Engineered research workflow on GCP Ubuntu Linux VM using Docker for environment isolation. Compiled statistical summaries via Pandas and NumPy[cite: 1].
              </p>
              <span style={{ color: '#ef4444', fontSize: '0.8rem', fontWeight: 700 }}>DOCKER • GCP • PYTHON • PANDAS</span>
            </div>

            <div className="interactive-card" style={{ background: theme.cardBg, border: `1px solid ${theme.cardBorder}`, padding: '2.5rem', borderRadius: '1rem', backdropFilter: 'blur(12px)' }}>
              <h3 style={{ fontSize: '1.35rem', marginBottom: '0.8rem', color: theme.textMain }}>System Compliance Reporting Architecture[cite: 1]</h3>
              <p style={{ color: theme.textMuted, fontSize: '0.95rem', lineHeight: 1.6, marginBottom: '1.5rem' }}>
                Designed Power Apps reporting architecture to monitor learning environments and identify WCAG 2.1 compliance errors across 500+ active university courses[cite: 1].
              </p>
              <span style={{ color: '#ef4444', fontSize: '0.8rem', fontWeight: 700 }}>POWER APPS • AUTOMATION • WCAG 2.1</span>
            </div>

            <div className="interactive-card" style={{ background: theme.cardBg, border: `1px solid ${theme.cardBorder}`, padding: '2.5rem', borderRadius: '1rem', backdropFilter: 'blur(12px)' }}>
              <h3 style={{ fontSize: '1.35rem', marginBottom: '0.8rem', color: theme.textMain }}>AI-Powered Virtual Assistant (Copilot)[cite: 1]</h3>
              <p style={{ color: theme.textMuted, fontSize: '0.95rem', lineHeight: 1.6, marginBottom: '1.5rem' }}>
                Engineered conversational AI agent utilizing OpenAI API with context-aware prompt engineering, voice pipeline (TTS/STT), and modular backend REST APIs[cite: 1].
              </p>
              <span style={{ color: '#ef4444', fontSize: '0.8rem', fontWeight: 700 }}>OPENAI API • PYTHON • REST APIS</span>
            </div>

            <div className="interactive-card" style={{ background: theme.cardBg, border: `1px solid ${theme.cardBorder}`, padding: '2.5rem', borderRadius: '1rem', backdropFilter: 'blur(12px)' }}>
              <h3 style={{ fontSize: '1.35rem', marginBottom: '0.8rem', color: theme.textMain }}>LinkNews Mobile App (Flutter)[cite: 1]</h3>
              <p style={{ color: theme.textMuted, fontSize: '0.95rem', lineHeight: 1.6, marginBottom: '1.5rem' }}>
                Developed cross-platform app using Flutter and Dart. Integrated asynchronous JSON REST API pipelines and Firebase Cloud Messaging (FCM) notifications[cite: 1].
              </p>
              <span style={{ color: '#ef4444', fontSize: '0.8rem', fontWeight: 700 }}>FLUTTER • DART • FIREBASE FCM</span>
            </div>

            <div className="interactive-card" style={{ background: theme.cardBg, border: `1px solid ${theme.cardBorder}`, padding: '2.5rem', borderRadius: '1rem', backdropFilter: 'blur(12px)' }}>
              <h3 style={{ fontSize: '1.35rem', marginBottom: '0.8rem', color: theme.textMain }}>Personal Diary App[cite: 1]</h3>
              <p style={{ color: theme.textMuted, fontSize: '0.95rem', lineHeight: 1.6, marginBottom: '1.5rem' }}>
                Built full CRUD mobile application with Provider state management, dynamic light/dark themes, and local storage data persistence via shared preferences[cite: 1].
              </p>
              <span style={{ color: '#ef4444', fontSize: '0.8rem', fontWeight: 700 }}>FLUTTER • PROVIDER • LOCAL STORAGE</span>
            </div>

            <div className="interactive-card" style={{ background: theme.cardBg, border: `1px solid ${theme.cardBorder}`, padding: '2.5rem', borderRadius: '1rem', backdropFilter: 'blur(12px)' }}>
              <h3 style={{ fontSize: '1.35rem', marginBottom: '0.8rem', color: theme.textMain }}>LMS Accessibility & Student Success Analysis[cite: 1]</h3>
              <p style={{ color: theme.textMuted, fontSize: '0.95rem', lineHeight: 1.6, marginBottom: '1.5rem' }}>
                Processed 10,000+ LMS records using Python and PostgreSQL inside Docker. Built interactive Tableau Public dashboards for academic leadership[cite: 1].
              </p>
        ...
        <section id="skills" style={{ minHeight: '70vh', display: 'flex', flexDirection: 'column', justifyContent: 'center', padding: '10vh 10vw' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '2rem' }}>
            ...
            <div style={{ background: theme.cardBg, border: `1px solid ${theme.cardBorder}`, padding: '2rem', borderRadius: '1rem', backdropFilter: 'blur(12px)' }}>
              <h3 style={{ color: '#ef4444', fontSize: '1.2rem', marginBottom: '1rem' }}>Programming Languages</h3>
              <p style={{ color: theme.textMuted, lineHeight: 1.6 }}>Python, SQL, JavaScript, HTML, Dart[cite: 1]</p>
            </div>

            <div style={{ background: theme.cardBg, border: `1px solid ${theme.cardBorder}`, padding: '2rem', borderRadius: '1rem', backdropFilter: 'blur(12px)' }}>
              <h3 style={{ color: '#ef4444', fontSize: '1.2rem', marginBottom: '1rem' }}>Frameworks & Libraries</h3>
              <p style={{ color: theme.textMuted, lineHeight: 1.6 }}>Pandas, NumPy, Flutter[cite: 1]</p>
            </div>

            <div style={{ background: theme.cardBg, border: `1px solid ${theme.cardBorder}`, padding: '2rem', borderRadius: '1rem', backdropFilter: 'blur(12px)' }}>
              <h3 style={{ color: '#ef4444', fontSize: '1.2rem', marginBottom: '1rem' }}>Tools & Software</h3>
              <p style={{ color: theme.textMuted, lineHeight: 1.6 }}>Ubuntu Linux, Docker, Containerization, Liferay, Brightspace, Sakai, Power Apps, Jira, TDX, Git, GitHub, Tableau[cite: 1]</p>
            </div>

            <div style={{ background: theme.cardBg, border: `1px solid ${theme.cardBorder}`, padding: '2rem', borderRadius: '1rem', backdropFilter: 'blur(12px)' }}>
              <h3 style={{ color: '#ef4444', fontSize: '1.2rem', marginBottom: '1rem' }}>Cloud & Soft Skills</h3>
              <p style={{ color: theme.textMuted, lineHeight: 1.6 }}>Google Cloud Platform, Firebase, Faculty Workshops, Technical Consulting[cite: 1]</p>
            </div>
        ...
        <section id="education" style={{ minHeight: '70vh', display: 'flex', flexDirection: 'column', justifyContent: 'center', padding: '10vh 10vw' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '2rem', maxWidth: '900px' }}>
            ...
            <div style={{ background: theme.cardBg, border: `1px solid ${theme.cardBorder}`, padding: '2.5rem', borderRadius: '1rem', backdropFilter: 'blur(12px)' }}>
              <h3 style={{ fontSize: '1.4rem', color: theme.textMain, marginBottom: '0.4rem' }}>Marist College[cite: 1]</h3>
              <h4 style={{ color: '#38bdf8', fontSize: '1.05rem', marginBottom: '1rem' }}>Master of Science, Information Systems • Jan 2025 – Dec 2026 (GPA: 3.845)[cite: 1]</h4>
            </div>

            <div style={{ background: theme.cardBg, border: `1px solid ${theme.cardBorder}`, padding: '2.5rem', borderRadius: '1rem', backdropFilter: 'blur(12px)' }}>
              <h3 style={{ fontSize: '1.4rem', color: theme.textMain, marginBottom: '0.4rem' }}>Keshav Memorial Institute Of Technology[cite: 1]</h3>
              <h4 style={{ color: '#38bdf8', fontSize: '1.05rem', marginBottom: '1rem' }}>Bachelor of Technology, CSM • Aug 2020 – May 2024 (GPA: 3.5)[cite: 1]</h4>
            </div>
        ...
        <section id="contact" style={{ height: '100vh', display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', textAlign: 'center', padding: '0 10vw' }}>
          ...
          <p style={{ color: theme.textMuted, fontSize: '1.2rem', marginBottom: '3rem', maxWidth: '600px' }}>
            Poughkeepsie, New York[cite: 1] • (551) 297-5781[cite: 1] • vishnukaushikvarma@gmail.com[cite: 1]
          </p>
